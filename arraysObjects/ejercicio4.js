...
function encontrarPorTitulo(tituloBuscado) {
    return libros.find(libro => libro.titulo.toLowerCase() === tituloBuscado.toLowerCase());
}

console.log(encontrarPorTitulo("el principito"));

// 1. Array de objetos (ya está creado)
